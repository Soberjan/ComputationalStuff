...
tol = 1E-14
# u_0 = Expression(("(x[0] <= 1 + tol ? 1.25 : 0.12)", "(x[0] <= 1 + tol ? -0.1 : -0.0299)"), degree=0, L=L, tol=tol)
u_0 = Expression(("(x[0] <= 1 + tol ? 0.2 : 0.12)", "(x[0] <= 1 + tol ? -0.0299 : -0.0299)"), degree=0, L=L, tol=tol)
u_n = Function(V)
